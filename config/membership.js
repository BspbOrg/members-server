exports.default = {
  membership: {
    expiringReminder: {
      ...
      frequency: (process.env.EXPIRING_REMINDER_FREQUENCY || 0 /* days */) * 1000 * 60 * 60 * 24,
      // If membership expires in less than this number of days it will consider sending reminder
      maxDays: process.env.EXPIRING_REMINDER_MAX_DAYS || 30,
    ...
    expiredNotice: {
      ...
      frequency: (process.env.EXPIRED_NOTICE_FREQUENCY || 0 /* days */) * 1000 * 60 * 60 * 24,
      // If membership expired in more than this number of days it will NOT send notice
      maxDays: process.env.EXPIRED_NOTICE_MAX_DAYS || 90,
